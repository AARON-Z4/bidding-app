      ...
      <div className="relative diagonal-border backdrop-blur-2xl bg-white/10 text-white w-full max-w-md p-8 rounded-2xl">
        ...
        <div className="text-center mb-6">
          <div className="inline-block p-4 bg-purple-500/20 rounded-full mb-4">
            <i className="ri-store-line text-5xl text-purple-400"></i>
          </div>
          <h1 className="text-3xl font-bold">
            Seller <span className="text-[#24CFA6]">Portal</span>
          </h1>
          <p className="text-white/70 mt-2">
            {isLogin ? 'Welcome back, Seller!' : 'Create your seller account'}
          </p>
        </div>
        ...
        <div className="mt-4 text-center">
          ...
          >
            Are you a buyer? <span className="text-[#24CFA6]">Login here</span>
          </button>
        </div>
